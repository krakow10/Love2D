...
local setc=love.window.setTitle
...
local vs={love.graphics.getDimensions()}
local life=love.graphics.newShader(love.filesystem.read'glsl/GOL.glsl')
local paste=love.graphics.newShader(love.filesystem.read'glsl/Paste.glsl')
local random=love.graphics.newShader(love.filesystem.read'glsl/random.glsl')
local magnify=love.graphics.newShader(love.filesystem.read'glsl/magnify.glsl')
...
function love.resize(x,y)
	...
	send(life,"vs",vs)
	send(magnify,"vs",vs)
	local nc=love.graphics.newCanvas(x,y)
	nc:renderTo(function()
		draw(from)
	end)
	to=love.graphics.newCanvas(x,y)
	from=nc
end
