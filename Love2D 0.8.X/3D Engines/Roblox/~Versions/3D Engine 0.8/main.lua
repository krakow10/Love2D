...
local shader=graphics.newPixelEffect(filesystem.read'glsl/shader.glsl')

local function poly(m,v1,v2,v3,v4)
	polygon(m,v1.x,v1.y,v2.x,v2.y,v3.x,v3.y,v4.x,v4.y)
end
...
local renderBrick=function(self,c)
	...
	if v1 and v2 and v3 and v4 and campos.x>sx then--Works when the Quaternion isn't messed up
		...
		shader:send("pp1",Zt)
		shader:send("pp2",yt)
		poly(self.Right,v3,v4,v2,v1)--right
	end
	if v5 and v6 and v7 and v8 and campos.x<-sx then
		...
		shader:send("pp1",zt)
		shader:send("pp2",yt)
		poly(self.Left,v5,v6,v8,v7)--left
	end
	...
	if v3 and v4 and v7 and v8 and campos.y<-sy then
		...
		shader:send("pp1",xt)
		shader:send("pp2",zt)
		poly(self.Bottom,v7,v8,v4,v3)--bottom
	end
	if v1 and v3 and v5 and v7 and campos.z>sz then
		...
		shader:send("pp1",Xt)
		shader:send("pp2",yt)
		poly(self.Front,v5,v7,v3,v1)--front
	end
	if v2 and v4 and v6 and v8 and campos.z<-sz then
		...
		shader:send("pp1",xt)
		shader:send("pp2",yt)
		poly(self.Back,v2,v4,v8,v6)--back
	end
end
...
function love.update(t)
	...
	local dir=cam.Quaternion*screenToWorld(cam,newPos)
	m.Direction=dir
...
--[[
	...
	focus.Image=graphics.newImage'textures/Breaking Benjamin.png'
--]]
--[[
	local s=new'Sound'
	s.Object=focus
