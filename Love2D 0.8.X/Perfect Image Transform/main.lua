...
local render=love.graphics.newPixelEffect(love.filesystem.read'render.glsl')
local linear=love.graphics.newPixelEffect(love.filesystem.read'linear.glsl')
local nearest=love.graphics.newPixelEffect(love.filesystem.read'nearest.glsl')
